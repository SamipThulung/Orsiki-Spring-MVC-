...
<img id="desc" src="${pageContext.request.contextPath}/resources/images/${img}" style="height:320px;width:320px">
...
<button class="buyButton" onclick="document.getElementById('id01').style.display='block'" style="width:auto;margin-left:15%;"><img src="${pageContext.request.contextPath}/resources/images/68-256.png" style="height:35px;width:35px;"> Buy Now!</button>
